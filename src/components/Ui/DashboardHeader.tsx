    ...
    <header className="bg-white shadow-sm relative z-50">
      <div className="max-w-4xl mx-auto flex justify-between items-center p-4">
        ...
        <div className="relative" ref={notificationsRef}>
          ...
          {isNotificationsOpen && (
            <div className="absolute right-0 mt-2 w-screen max-w-sm bg-white rounded-lg shadow-lg border border-gray-200 transform origin-top-right transition-all duration-200 ease-out md:max-w-md lg:max-w-lg">
